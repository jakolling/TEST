...
# All components included - v3.0 (Fixed Syntax)
...
if uploaded_files:
    ...
    try:
        ...
        numeric_cols = df_minutes.select_dtypes(include=[np.number]).columns.tolist()
        tabs = st.tabs(['Radar', 'Bars', 'Scatter', 'Profiler', 'Correlation', 'Composite Index (PCA)'])

        # =============================================
        # Radar Chart (Tab 1) - Fixed Version
        # =============================================
        with tabs[0]:
            ...
            if 6 <= len(sel) <= 12:
                ...
                # Percentiles against full dataset
        ...
        # =============================================
        # Scatter Plot (Tab 3) - Fixed Parentheses
        # =============================================
        with tabs[2]:
        ...
        # =============================================
        # Composite PCA Index (Tab 6) - Fixed Version
        # =============================================
        with tabs[5]:
