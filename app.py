...
if selected_leagues:
    ...
    with tabs[0]:
        ...
        if metric_selection_mode == "Use Metric Presets":
            ...
            # Inicializar variável temporária para as métricas de preset
            if 'temp_pizza_preset_metrics' not in st.session_state:
                # Usar métricas salvas anteriormente ou as métricas do preset
                if 'saved_pizza_metrics' in st.session_state and st.session_state.saved_pizza_metrics:
                    ...
                    st.session_state.temp_pizza_preset_metrics = valid_metrics if valid_metrics else preset_metrics
                else:
